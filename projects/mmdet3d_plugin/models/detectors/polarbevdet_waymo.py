...
class PolarBEVDetWaymo(BEVDet):
    def __init__(self,
                 ...
                 load_interval=5,
                 **kwargs):
        super(PolarBEVDetWaymo, self).__init__(**kwargs)
    ...
    def fuse_history(self, curr_bev, bda, ego2globals, img_metas):
        ...
        self.history_egopose = torch.inverse(self.ego2globals)  # global --> ego

        if not self.idx % self.load_interval == 0:
            self.history_sweep_time -= 1
