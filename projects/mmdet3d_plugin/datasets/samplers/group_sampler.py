...
#             for group_idx in range(self.groups_num)}        # 记录每个group包含的sample_id.
#
...
#             for local_sample_idx in range(self.batch_size)]     # 记录当前rank，不同batch_id负责读取的group_id
#
...
#                     # 当前group已经读取完，将下一个group(new_group_idx)包含的sample_id放入到buffer_per_local_sample中.
